$(function() {
    ...
    function c() {
            ...
            if ($(this).data("id") == o) {
                if (!$(this).hasClass("active")) {
                    ...
                    $(".J_mainContent .J_iframe").each(function() {
                        if ($(this).data("id") == o) {
                            $(this).show().siblings(".J_iframe").fadeOut(250);
                            return false
                        }
                    })
                }
        ...
        if (k) {
            ...
            var n = '<iframe class="J_iframe" id="iframe' + m + '" name="iframe' + m + '" style="display: none;" width="100%" height="100%" src="' + o + '" frameborder="0" data-id="' + o + '" seamless></iframe>';
